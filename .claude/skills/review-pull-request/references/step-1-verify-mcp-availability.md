...
Determine how to read and post PR data, in this order of preference:
...
> "This skill needs either an MCP integration or a platform CLI (`gh`, `glab`, or a Bitbucket CLI) to fetch PR data. None was found. Please configure one and retry."
